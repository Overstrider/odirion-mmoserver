...
if NpcHandler == nil then
	...
	function NpcHandler:doNPCTalkALot(msgs, interval, pcid)
		...
		for aux = 1, #msgs do
			...
			doCreatureSayWithDelay(getNpcCid(), msgs[aux], TALKTYPE_PRIVATE_NP, ((aux-1) * (interval or 1000)), self.eventDelayedSay[pcid][aux], pcid)
	...
	function NpcHandler:say(message, focus, publicize, shallDelay, delay)
		if type(message) == "table" then
			return self:doNPCTalkALot(message, delay or 2000, focus)
		end
