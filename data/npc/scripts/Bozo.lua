...
if msgcontains(msg, 'job') then
	NPCSay("I am the royal jes ... uhm ... the royal tax-collector! Do you want to pay your taxes?", 1)
	bozo_talk_state = 1
...
elseif bozo_talk_state == 3 and msgcontains(msg, '') then	
	NPCSay("You dont know what offer you have passed!", 1)
	bozo_talk_state = 0	
	
elseif msgcontains(msg, 'magic') or msgcontains(msg, 'spell') then	
	NPCSay("I actually know some spells! Do you want to learn how to 'lessen your load' for 200 gold?", 1)
	bozo_talk_state = 2	
...
elseif bozo_talk_state == 2 and msgcontains(msg, '') then	
	NPCSay("You don't know what offer you have passed!", 1)
	bozo_talk_state = 0

elseif msgcontains(msg, 'paladin') then	
	if getPlayerVocation(cid) == 3 or getPlayerVocation(cid) == 7 then
	NPCSay("I wanted to become a paladin, too, but I was overqualified!", 1)
	else
	NPCSay("They are the king's favourites, because they know how to 'bow'.", 1)
	end
	bozo_talk_state = 0	
elseif msgcontains(msg, 'sorcerer') then	
	if getPlayerVocation(cid) == 1 or getPlayerVocation(cid) == 5 then
	NPCSay("I wanted to become a sorcerer, too, but I was overqualified!", 1)
	else
	NPCSay("The good thing about them is that they can't be at two places at the same time.", 1)
	end
	bozo_talk_state = 0	
elseif msgcontains(msg, 'druid') then	
	if getPlayerVocation(cid) == 2 or getPlayerVocation(cid) == 6 then
	NPCSay("I wanted to become a Druid, too, but I was overqualified!", 1)
	else
	NPCSay("If you are in Druidville, do as the rabbits do.", 1)
	end
	bozo_talk_state = 0	
elseif msgcontains(msg, 'knight') then	
	if getPlayerVocation(cid) == 4 or getPlayerVocation(cid) == 8 then
	NPCSay("I wanted to become a knight, too, but I was overqualified!", 1)
	else
	NPCSay("Did you notice that old knights have their scars just on their backs?", 1)
	end
	bozo_talk_state = 0
elseif msgcontains(msg, 'lady') then	
	if getPlayerSex(cid) == 1 then
	NPCSay("Well, you don't behave ladylike just because you dress like one!", 1)
	bozo_talk_state = 0
	else
	NPCSay("Has any man said to you that you're not only beautiful but also intelligent?", 1)
	bozo_talk_state = 5
	end	
elseif bozo_talk_state == 5 and msgcontains(msg, 'yes') then
	NPCSay("This is a world of fantasy and full of surprises!", 1)
	bozo_talk_state = 0
elseif bozo_talk_state == 5 and msgcontains(msg, '') then
	NPCSay("Well, think about it!", 1)
	bozo_talk_state = 0
