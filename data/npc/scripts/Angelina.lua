...
if msgcontains(msg, 'teleport') and npcHandler.focus == cid then
	...
	NPCSay("I am still gathering my strength for a teleport home, but some power already has returned. Do you wish to be teleported out of this cell?", 1)
...
elseif angelina_talk_state == 0 and msgcontains(msg, 'job') and npcHandler.focus == cid then
	NPCSay("I am a priestess and I travelled here to learn about that order of the humble path I heard about. ...", 1)
	NPCSay('But when I started my investigations, this false monk Lorbas thought that I was suspicious and so he ordered his minions to take me as prisoner.', 5)

elseif angelina_talk_state == 0 and msgcontains(msg, 'cult') and npcHandler.focus == cid then
	NPCSay("The cult is secretly looking for the unsatisfied, disgrunteled and poor. Its members promise such sad individuals wealth, revenge and a cause. ...", 1)
	NPCSay("They lure them into the cells of their cult. Here they learn how to undermine the authorities of their cities. They are trained as thieves, spies and smugglers first. ...", 5)
	NPCSay("Those who prove themselves as the most promising candidates are recruited to a special hidden circle. There they learn the dark arts of poisoning and murder, or elocution and agitation to become assassins and recruiters for the cult. ...", 9)
	NPCSay("I know nothing about their agenda but I am quite sure there has to be some higher power behind all of this.", 13)

elseif angelina_talk_state == 0 and msgcontains(msg, 'cathedral') and npcHandler.focus == cid then
	NPCSay("The cathedral was meant to be a centre of piety and believe. A prayer to the gods that had become solid. ...", 1)
	NPCSay("The construction works started at the height of the Order of the Nightmare Knights, right after they had won a major battle near the place where the cathedral was to be built. ...", 5)
	NPCSay("The cathedral was meant to become a monument of the victory of good over evil. ...", 9)
	NPCSay("Sadly it was just not meant to be. ...", 13)
	NPCSay("As the cathedral was nearly finished, most of the monks had already moved in and even a small town for all the workers and suppliers had established itself. ...", 17)
	NPCSay("But then the structure was struck by an earthquake and the work of two generations was destroyed. ...", 21)
	NPCSay("Later the dwarven constructors explained that this was caused by volcanic activities and a massive cave-in. ...", 25)
	NPCSay("Since the gods did not interfere and the setting was close to the notorious Pits of Inferno, it was assumed that this was the work of secret demonic powers.", 29)	
end		
    return 1
end
