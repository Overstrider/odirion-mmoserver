...
function creatureSayCallback(cid, type, msg) msg = string.lower(msg)
	...
	if getPlayerVocation(cid) == 2 or getPlayerVocation(cid) == 6 then
		...
		NPCSay("Sorry, I only sell spells to druids.", 1)
		return false
		end
	end
--name the spell--
...
elseif marvik_talk_state == 8754 and msgcontains(msg, 'yes') then
	if isInArray(spellvoc, getPlayerVocation(cid)) == 1 then
...
elseif marvik_talk_state == 8754 and msgcontains(msg, '') then
...
NPCSay("I sell 'Find Person', 'Light', 'Create Food', 'Light Healing', 'Light Magic Missile', 'Antidote', 'Intense Healing', 'Poison Field', 'Great Light', 'Fire Field', 'Heavy Magic Missile', 'Magic Shield', 'Intense Healing Rune', 'Antidote Rune' and. ...", 1)
NPCSay("'Fireball', 'Energy Field', 'Destroy Field', 'Ultimate Healing', 'Great Fireball', 'Firebomb', 'Creature Illusion', 'Convince Creature', 'Ultimate Healing Rune', 'Chameleon', 'Poison Wall', 'Explosion' and. ...", 5)
NPCSay("'Fire Wall', 'Invisible', 'Summon Creature' and 'Energy Wall'.", 9)
marvik_talk_state = 0	
