...
shopModule:addSellableItem({'dragon scale mail'},2492, 30000,'dragon scale mail')
...
shopModule:addSellableItem({'ring of the sky'},2123, 20000,'ring of the sky')
shopModule:addSellableItem({'bright sword'},2407, 8000,'bright sword')
shopModule:addSellableItem({'golden ring'},2179, 8000,'golden ring')
shopModule:addSellableItem({'guardian halberd'},2427, 8000,'guardian halberd')
shopModule:addSellableItem({'medusa shield'},2536, 8000,'medusa shield')
shopModule:addSellableItem({'scarab shield'},2540, 1500,'scarab shield')
...
shopModule:addSellableItem({'mystic turban'},2663, 1000,'mystic turban')
shopModule:addSellableItem({'ancient amulet'},2142, 500,'ancient amulet')
shopModule:addSellableItem({'scarab amulet'},2135, 500,'scarab amulet')
shopModule:addSellableItem({'bone shield'},2541, 100,'bone shield')
...
shopModule:addSellableItem({'dwarven armor'},2503, 40000,'dwarven armor')
...
shopModule:addSellableItem({'prharaoh sword'},2446, 23000,'pharaoh sword')
