...
if msgcontains(msg, 'vanity') or msgcontains(msg, 'Vanity') then
	NPCSay("In our vanity we thought that we could impress the gods with our money and show piety by building them a monument. ...", 1)
	NPCSay("We were wrong and the gods punished us by sending the worst earthquake that mankind has seen. ...", 5)
	NPCSay("Its ground motions could still be felt in Thais and as the dust settled, little had remained of that what we had built. ...", 9)
	NPCSay("Most members of our order were dead, others turned mad or lost faith. We are all that is left from our glorious order.", 13)
	name_talk_state = 0
	
elseif msgcontains(msg, 'cathedral') or msgcontains(msg, 'Cathedral') then
	NPCSay("What was once planned as the most impressive cathedral of all times, lies now in ruins. ...", 1)
	NPCSay("All what the earthquake has left over is a heap of rubble. The ruins are cursed and everybody who dares to go there will draw the ire of heaven on himself. ...", 5)
	NPCSay("All those that travel there are infested with bad luck. But only few have returned from this treacherous ground. Noxious fumes are killing intruders almost unnoticed. ...", 9)
	NPCSay("Crumbling structures might kill you instantly. ...", 13)
	NPCSay("Those who survive the dangers of nature will face the soul-eating ghosts of those who have died in the catastrophe. ...", 17)
	NPCSay("It's not worth to go there, there are no richnesses or treasures left in the ruins, the gold of our order melted away in funding the cathedral's construction. ...", 21)
	NPCSay("I urge you to stay away from the cursed ground and the ruins. For the safety of your body and your soul keep away from there.", 25)
	name_talk_state = 0

elseif msgcontains(msg, 'assassin') or msgcontains(msg, 'dark monk') then
	NPCSay("I know nothing about that topic. If you would excuse me, I have things to attend.", 1)
