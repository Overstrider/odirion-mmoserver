...
if msgcontains(msg, 'morrin') or msgcontains(msg, 'Morrin') then 
	npcHandler:say('Ah, I remember that man. We made a deal, guess about what.')
	hagor_talk_state = 1

elseif hagor_talk_state == 1 and msgcontains(msg, 'key') or hagor_talk_state == 1 and  msgcontains(msg, 'Key') then 
	npcHandler:say('Right! We can make the same deal if you give a fresh delicious roll. Do you have any?')
	hagor_talk_state = 2	
