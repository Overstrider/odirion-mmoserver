...
local voices = { {text = 'Passages to Thais, Carlin, Ab\'Dendriel, Edron, Darashia and Ankrahmun.'} }
...
-- Basic
keywordHandler:addKeyword({'sail'}, StdModule.say, {npcHandler = npcHandler, text = 'Where do you want to go? To {Thais}, {Carlin}, {Ab\'Dendriel}, {Edron}, {Darashia} or {Ankrahmun}?'})
keywordHandler:addKeyword({'passage'}, StdModule.say, {npcHandler = npcHandler, text = 'Where do you want to go? To {Thais}, {Carlin}, {Ab\'Dendriel}, {Edron}, {Darashia} or {Ankrahmun}?'})
