...
shopModule:addBuyableItem({'arrow','arrow'}, 2544, 2,1,'arrow')
shopModule:addBuyableItem({'bolt','bolt'}, 2543, 3,1,'bolt')
shopModule:addBuyableItem({'hunting arrow','hunting arrow'}, 6077, 4,1,'hunting arrow')
shopModule:addBuyableItem({'hunter spear','hunter spear'}, 6052, 250,1,'hunter spear')
