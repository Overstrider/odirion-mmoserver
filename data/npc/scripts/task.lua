...
local difficultyNpcSay = "What is the difficulty of the task you want to do: easy, medium or hard?"
...
for difficulty, text in ipairs(TaskSystem.DifficultyLevelOrdened) do
    local taskNpcSay = "Tell me the breed of the monster that you want to hunt: ".. TaskSystem:GetTaskList(difficulty).. "."
