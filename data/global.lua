    ...
    for a = 1, #list do
        if (a+1) == #list then
            if list[a].count <= 1 then
                awardList = awardList.."{"..list[a].count.."x "..ItemType(list[a].id):getName().."} and "
            else
                awardList = awardList.."{"..list[a].count.."x "..getItemDescriptions(list[a].id).plural.."} and "
            end
        elseif (a+1) > #list then
            if list[a].count <= 1 then
                awardList = awardList.."{"..list[a].count.."x "..ItemType(list[a].id):getName().."}"
            else
                awardList = awardList.."{"..list[a].count.."x "..getItemDescriptions(list[a].id).plural.."}"
            end
        else
            if list[a].count <= 1 then
                awardList = awardList.."{"..list[a].count.."x "..ItemType(list[a].id):getName().."}, "
