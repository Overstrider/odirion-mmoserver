...
elseif item.uid == 7012 then
	...
	doAddContainerItem(BEARROOMBAG, 2544, 12)
	doAddContainerItem(BEARROOMBAG, 2148, 40)
...
elseif item.uid == 7015 then
	...
	doAddContainerItem(DRAGONCORPSE, 2480, 1)
	doAddContainerItem(DRAGONCORPSE, 2530, 1)
...
elseif item.uid == 7016 then
	...
	doAddContainerItem(GOBBLINTEMPLEBAG1, 2563, 1)
	doAddContainerItem(GOBBLINTEMPLEBAG1, 1294, 5)
	doAddContainerItem(GOBBLINTEMPLEBAG1, 2148, 50)
...
elseif item.uid == 7017 then
	...
	doAddContainerItem(GOBBLINTEMPLEBAG2, 2111, 4)
	doAddContainerItem(GOBBLINTEMPLEBAG2, 2642, 1)
...
elseif item.uid == 7022 then
	...
	doAddContainerItem(CARLINSWORDBAG, 2545, 4)
	doAddContainerItem(CARLINSWORDBAG, 2544, 10)
...
elseif item.uid == 7025 then
	...
	PRESENTBP = doPlayerAddItem(cid, 1988, 1)
	doAddContainerItem(PRESENTBP, 2013, 1)
	doAddContainerItem(PRESENTBP, 2035, 1)
	doAddContainerItem(PRESENTBP, 2014, 1)
...
elseif item.uid == 7038 then
	...
	SPIKESWORDKEY = doPlayerAddItem(cid, 2091, 1)
