local itemFunctions = {
	...
	["uniqueid"] = { isActive = true, targetFunction = function (item, target) return item:setUniqueId(target) end },
...
local playerFunctions = {
	...
	["vocation"] = { isActive = true, targetFunction = function (player, target) return player:setVocation(target) end },
