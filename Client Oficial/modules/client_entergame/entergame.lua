...
function EnterGame.init()
  ...
  subServer = enterGame:getChildById('subServer')
  
  subServer:addOption("Alfa")
  subServer:addOption("Gama")
  
  EnterGame.setUniqueServer('34.67.85.179', 7171, 860)
end
...
function EnterGame.doLogin()
  ...
  if subServer:getText() == "Alfa" then
	G.port = 7171
  else
	G.port = 7171
  end
