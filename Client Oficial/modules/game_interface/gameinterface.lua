...
function init()
  ...
  gameExtraRightPanel = gameRootPanel:recursiveGetChildById('gameExtraRightPanel')
  gameBottomPanel = gameRootPanel:getChildById('gameBottomPanel')
  conditionPanel = gameRootPanel:getChildById('conditionPanel')
  firstBoost = conditionPanel:getChildById('firstBoost')
  secondBoost = conditionPanel:getChildById('secondBoost')
  threeBoost = conditionPanel:getChildById('threeBoost')
...
function terminate()
  ...
  -- ProtocolGame.unregisterExtendedOpcode(15)
  -- ProtocolGame.unregisterExtendedOpcode(16)
...
function show()
  ...
  ProtocolGame.registerExtendedOpcode(10, checkBot)
  
  -- ProtocolGame.registerExtendedOpcode(15, checkBot)    
  -- ProtocolGame.registerExtendedOpcode(16, checkBot)    
  -- ProtocolGame.registerExtendedOpcode(17, checkBot)    
end
...
function checkBot(protocol, opcode, buffer)
	if opcode == 10 then
		g_game.getProtocolGame():sendExtendedOpcode(10, 1)
		ProtocolGame.unregisterExtendedOpcode(10)
		
	elseif opcode == 15 then
		firstBoost:setImageSource(string.table(buffer, "@")[1])
		firstBoost:setTooltip(string.table(buffer, "@")[2])
		ProtocolGame.unregisterExtendedOpcode(15)
		
	elseif opcode == 16 then
		secondBoost:setImageSource(string.table(buffer, "@")[1])
		secondBoost:setTooltip(string.table(buffer, "@")[2])
		ProtocolGame.unregisterExtendedOpcode(16)
		
	elseif opcode == 17 then
		threeBoost:setImageSource(string.table(buffer, "@")[1])
		threeBoost:setTooltip(string.table(buffer, "@")[2])
		ProtocolGame.unregisterExtendedOpcode(17)
	end
end
  ...
  if creatureThing then
    ...
    if creatureThing:isLocalPlayer() then
      ...
      if creatureThing:isPlayer() then
        ...
        menu:addOption(tr('Message to %s', creatureName), function() g_game.openPrivateChannel(creatureName) modules.game_console.addTab(creatureName, true) end)
...
function onExtraRightPanelVisibilityChange(extraRightPanel, visible)
	if visible then
		gameMapPanel:addAnchor(AnchorRight, 'gameExtraRightPanel', AnchorLeft)
		gameBottomPanel:addAnchor(AnchorRight, 'gameExtraRightPanel', AnchorLeft)
		gameBottomPanel:addAnchor(AnchorRight, 'gameExtraRightPanel', AnchorLeft)
		bottomSplitter:addAnchor(AnchorRight, 'gameExtraRightPanel', AnchorLeft)
	else
		gameMapPanel:addAnchor(AnchorRight, 'gameRightPanel', AnchorLeft)
		gameBottomPanel:addAnchor(AnchorRight, 'gameRightPanel', AnchorLeft)
		gameBottomPanel:addAnchor(AnchorRight, 'gameRightPanel', AnchorLeft)
		bottomSplitter:addAnchor(AnchorRight, 'gameRightPanel', AnchorLeft)
	end
