...
function init()
  ...
  refresh()
  skillsWindow:setup()
  ProtocolGame.registerExtendedOpcode(30, onRegenerationChange) 
end
...
function terminate()
  ...
  ProtocolGame.unregisterExtendedOpcode(30)	
end
...
function setSkillVisible(id, value)
  local skill = skillsWindow:recursiveGetChildById(id)
  local widget = skill:getChildById('value')
  widget:setText(value)
...
function setSkillPercentVisible(id, percent, tooltip)
  local skill = skillsWindow:recursiveGetChildById(id)
  local widget = skill:getChildById('percent')
  if widget then
    widget:setPercent(math.floor(percent))
...
function onStaminaChange(localPlayer, stamina)
  ...
  -- setSkillPercentVisible('stamina', percent, tr('You have %s percent', percent))
  -- setSkillVisible('stamina', hours .. ":" .. minutes)
end
...
function onRegenerationChange(protocol, opcode, buffer)
local regenerationTime = tonumber(buffer)
