...
local function setupPanelEngines()
  local enginesRadioGroup = UIRadioGroup.create()
  local left = panels:getChildById('leftpanel')
  local extra = panels:getChildById('extrapanel')
  local right = panels:getChildById('rightpanel')
  enginesRadioGroup:addWidget(left)
  enginesRadioGroup:addWidget(extra)
  enginesRadioGroup:addWidget(right)
  -- print(getOption('defaultPanel'))
  if g_settings.get('defaultPanel') == 'right' then
	enginesRadioGroup:selectWidget(right)
  elseif g_settings.get('defaultPanel') == 'extra' then
	enginesRadioGroup:selectWidget(extra)
  elseif g_settings.get('defaultPanel') == 'left' then
	enginesRadioGroup:selectWidget(left)
  end
  
  enginesRadioGroup.onSelectionChange = function(self, selected)
    if selected == right then
      setOption('defaultPanel', 'right')
    elseif selected == extra then
      setOption('defaultPanel', 'extra')
	elseif selected == left then
	  setOption('defaultPanel', 'left')
	end    
  end
...
function init()
  ...
  panels = g_ui.loadUI('panels')
  optionsTabBar:addTab(tr('Panels'), panels, '/images/optionstab/panels')
