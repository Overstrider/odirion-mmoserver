...
class LuaScriptInterface
{
	...
	protected:
		...
		static int luaPlayerGetFeed(lua_State* L);
		...
		static int luaPlayerSetUniqueCliente(lua_State* L);
		static int luaPlayerGetUniqueCliente(lua_State* L);
		...
		static int luaPlayerSendDisconnectClient(lua_State* L);
		...
		static int luaItemTypeSetElementType(lua_State* L);
