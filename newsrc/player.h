...
class Player final : public Creature, public Cylinder
{
	public:
		...
		void setUniqueCliente(const std::string& message) {
			if (client) {
				uniqueCliente = message;
			}
		}

		std::string getUniqueCliente() const {
			return uniqueCliente;
		}
		...
		void sendDisconnectClient(const std::string& message) {
			if (client) {
