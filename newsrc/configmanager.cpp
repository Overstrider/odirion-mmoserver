...
bool ConfigManager::load()
{
	...
	integer[RATE_REGENMANA]	= 		getGlobalNumber(L, "regenMana", 1);
	integer[RATE_REGENHEALTH]	= 		getGlobalNumber(L, "regenHealth", 1);
	...
	floating[RATE_RESPAWN] = getGlobalFloat(L, "rateRespaw", 1.0);
